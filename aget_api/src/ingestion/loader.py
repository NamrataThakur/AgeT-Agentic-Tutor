...
class InformationExtractor:
    def __init__(self):
        self.topic_factory = TopicsFactory()


    def get_extractor(self, topics: list[TopicsExtract]) -> Generator[list[Topics, list[Document]], None, None]:
...
if __name__ == "__main__":
    ...
    docs = info_extractor.extract_docs(
        log_reg,
        [
