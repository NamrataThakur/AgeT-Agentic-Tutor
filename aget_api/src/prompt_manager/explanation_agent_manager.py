...
from prompts.explanation_prompt import EXPLANATION_GENERATION_SYSTEM_PROMPT, EXPLANATION_GENERATION_USER_PROMPT


class ExplanationAgentPromptManager:
    def __init__(self):
        self.db = MongoDb()

    def create_explain_agent_prompt(self):
        system_prompt_template = EXPLANATION_GENERATION_SYSTEM_PROMPT
        user_prompt_template = EXPLANATION_GENERATION_USER_PROMPT
        ...
        try:
            ...
            print(f"Exception during Explantion Agent's prompt versioning and ingestion : {str(e)}")
            raise
...
if __name__ == "__main__":
    prompt_creator = ExplanationAgentPromptManager()
    prompt = prompt_creator.create_explain_agent_prompt()
    print(prompt)
