...
from prompts.evaluation_prompt import EVAL_AGENT_SYSTEM_PROMPT, EVAL_AGENT_USER_PROMPT

class EvaluationAgentPromptManager:
    def __init__(self):
        self.db = MongoDb()

    def create_question_agent_prompt(self):
        system_prompt_template = EVAL_AGENT_SYSTEM_PROMPT
        user_prompt_template = EVAL_AGENT_USER_PROMPT
        ...
        try:
            ...
            print("Prompt for Evaluation Agent Versioned and Inserted into MongoDB Collection..!")
            ...
            print(f"Exception during Question Agent's prompt versioning and ingestion : {str(e)}")
            raise
...
if __name__ == "__main__":
    prompt_creator = EvaluationAgentPromptManager()
    prompt = prompt_creator.create_question_agent_prompt()
    print(prompt)