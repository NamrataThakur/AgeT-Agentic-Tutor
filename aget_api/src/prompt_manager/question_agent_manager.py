...
from prompts.question_generation_prompt import QUESTION_GENERATION_SYSTEM_PROMPT, QUESTION_GENERATION_USER_PROMPT


class QuestionAgentPromptManager:
    def __init__(self):
        self.db = MongoDb()

    def create_question_agent_prompt(self):
        system_prompt_template = QUESTION_GENERATION_SYSTEM_PROMPT
        user_prompt_template = QUESTION_GENERATION_USER_PROMPT
...
if __name__ == "__main__":
    prompt_creator = QuestionAgentPromptManager()
