...
from pydantic_models.chunk import ChunkBatch
from pydantic_models.entity_relation import RelationAllBatch
from pydantic_models.chunk_graph import SemanticChunkBatch
    ...
    def create_memory(self, topics : List[TopicsExtract]):
        ...
        for idx, chunk in enumerate(docs_chunks):
            ...
            try:
                ...
                relations = self.relation_extractor.relation_extraction_pipeline(entities=entities, chunk=chunk)
        ...
        #represents, improves, increases, assesses
